      ...
      {showForm && (
        <div className="modal-overlay" onClick={e => { if (e.target === e.currentTarget) setShowForm(false); }}>
          <div className="modal-content">
            ...
            <div className="form-group"><label className="label">金额 *</label><input className="input" type="text" inputMode="decimal" value={form.amount} onChange={e => { const v = e.target.value.replace(',', '.'); if (v === '' || /^\d+\.?\d{0,2}$/.test(v)) setForm({ ...form, amount: v }); }} placeholder="0.00" disabled={!isAdmin && !!editing} /></div>
